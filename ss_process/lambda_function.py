...
function_arn = ''
train_job_name = ''
lambda_function_template_bucket = 'serverless-sagemaker'
lambda_function_template_zip = 'SagemakerReadyLambdaTemplate.zip'
...
def createLambdaFunction():
    ...
    try:
        ...
        s3.Bucket(lambda_function_template_bucket).download_file(lambda_function_template_zip,
        ...
        zipper.write('/tmp/lambda_function.py', os.path.basename('/tmp/lambda_function.py'))
        zipper.close()
...
# TODO - find a more performant way of doing this - should be an internal Pandas capability
